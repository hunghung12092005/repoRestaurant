    ...
    public function build()
    {
        ...
        switch ($this->status) {
            case 'confirmed_not_assigned':
                $subject = 'Xác Nhận Đặt Phòng Mã Đơn: ' . $this->booking->booking_id;
                $template = 'emails.booking_confirmed';
                break;
            case 'confirmed':
                $subject = 'Hoàn Tất Xác Nhận Đặt Phòng Mã Đơn: ' . $this->booking->booking_id;
                $template = 'emails.booking_completed';
                break;
            case 'cancelled':
                $subject = 'Hủy Đặt Phòng Mã Đơn: ' . $this->booking->booking_id;
                $template = 'emails.booking_cancelled';
                break;
            case 'room_assigned':
                $subject = 'Cập Nhật Xếp Phòng Cho Đặt Phòng Mã Đơn: ' . $this->booking->booking_id;
                $template = 'emails.room_assigned';
                break;
            default:
                $subject = 'Cập Nhật Trạng Thái Đặt Phòng Mã Đơn: ' . $this->booking->booking_id;
