...
<head>
    ...
    <title>Xác nhận Yêu cầu Hủy Đặt phòng</title>
    <style>
        body {
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
                    <tr>
                        <td align="center" style="background-color: #A98C58; padding: 30px 20px;">
                            ...
                            <p style="color: #f6f4f4; font-size: 16px; margin: 5px 0 0; font-family: 'Lato', sans-serif;">Xác nhận Yêu cầu Hủy Đặt phòng</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px 40px; color: #333333;">
                            ...
                            <p style="font-size: 16px; line-height: 1.6;">Chúng tôi đã nhận được yêu cầu hủy cho đơn đặt phòng của bạn và đang tiến hành xử lý. Chúng tôi sẽ thông báo đến bạn ngay khi quá trình hoàn tất.</p>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0;">
                                <tr>
                                    <td style="background-color: #fef9e7; border-left: 5px solid #f39c12; padding: 20px;">
                                        <p style="margin: 0; font-size: 16px; line-height: 1.6;">
                                            Trạng thái: 
                                            <strong style="color: #b07d12; font-size: 18px;">Đang chờ xử lý hủy</strong>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            @if (!empty($additionalInfo['cancellation_reason']) || !empty($additionalInfo['refund_amount']))
                                <h3 style="color: #715e3b; border-bottom: 2px solid #eeeeee; padding-bottom: 10px; margin-top: 30px; font-family: 'Merriweather', serif;">Chi tiết yêu cầu hủy</h3>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #333333; font-size: 16px;">
                                    ...
                                    @if (!empty($additionalInfo['refund_amount']))
                                        <tr>
                                            <td style="padding: 10px 0; border-top: 1px solid #eeeeee; font-weight: bold;">Số tiền hoàn lại dự kiến:</td>
                                            <td style="padding: 10px 0; border-top: 1px solid #eeeeee; text-align: right; font-weight: bold;">{{ number_format($additionalInfo['refund_amount'], 0, ',', '.') }} VND</td>
                                        </tr>
                                    @endif
                                </table>
                            @endif

                            <h3 style="color: #715e3b; border-bottom: 2px solid #eeeeee; padding-bottom: 10px; margin-top: 30px; font-family: 'Merriweather', serif;">Thông tin đặt phòng gốc</h3>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #333333; font-size: 16px;">
                                <tr>
                            ...
                            <p style="font-size: 16px; line-height: 1.6; margin-top: 30px;">Nếu bạn có bất kỳ thắc mắc nào trong thời gian này, xin vui lòng liên hệ với chúng tôi. Cảm ơn bạn.</p>
                        </td>
                    </tr>
                    <tr>
