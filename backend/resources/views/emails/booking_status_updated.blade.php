                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
                    <tr>
                        <td align="center" style="background-color: #A98C58; padding: 30px 20px;">
                            ...
                            <p style="color: #f6f4f4; font-size: 16px; margin: 5px 0 0; font-family: 'Lato', sans-serif;">Cập nhật về đơn đặt phòng của bạn</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px 40px; color: #333333;">
                            ...
                            <p style="font-size: 16px; line-height: 1.6;">Chúng tôi xin thông báo trạng thái mới nhất về đơn đặt phòng của bạn:</p>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0;">
                                <tr>
                                    <td style="background-color: #F9F6F0; border-left: 5px solid #A98C58; padding: 20px;">
                                        <p style="margin: 0; font-size: 16px; line-height: 1.6;">
                                            Trạng thái: 
                                            <strong style="color: #A98C58; font-size: 18px;">
                                                @switch($status)
                            ...
                            <p style="font-size: 16px; line-height: 1.6; margin-top: 30px;">Cảm ơn bạn đã tin tưởng và lựa chọn dịch vụ của Khách sạn Hồ Xuân Hương. Chúng tôi rất mong được đón tiếp bạn.</p>
                        </td>
                    </tr>
                    <tr>
