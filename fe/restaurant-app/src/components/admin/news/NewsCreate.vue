  ...
  <form @submit.prevent="handleSubmit">
    <div class="row">
      <div class="col-md-12 mb-3">
        ...
        <input type="text" class="form-control form-control-lg" v-model="form.title" required />
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 mb-3">
        <label for="summary" class="form-label">Tóm tắt</label>
        <textarea class="form-control form-control-lg" v-model="form.summary" rows="5"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 mb-3">
    ...
    <div class="row">
      <div class="col-md-12 mb-3">
        ...
        <select v-model="form.category_id" class="form-control form-control-lg">
    ...
    <div class="row">
      <div class="col-md-12 mb-3">
        ...
        <select v-model="form.status" class="form-control form-control-lg">
    ...
    <div class="row">
      <div class="col-md-12 mb-3">
        ...
        <input type="text" class="form-control form-control-lg" v-model="form.tags" />
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 mb-3">
...
const form = ref({
  ...
  summary: '',
  content: '',
  thumbnail: null, // Changed from string to null to handle file
  category_id: '',
  status: 1,
  tags: '',
  is_pinned: false,
